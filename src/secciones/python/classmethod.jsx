...
<body>
  <h1 id="decorador-classmethod">Decorador <span class="citation" data-cites="classmethod">@classmethod</span></h1>
  <p><code>@classmethod</code> permite crear funciones que pueden
...
<span id="cb1-20"><a href="#cb1-20" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(Persona.cuantos_hay())  <span class="co"># Hay 2 personas registradas.</span></span></code></pre>
  ...
  <hr />
  <h2 id="diferencias-entre-tipos-de-métodos">Diferencias entre tipos de
    métodos</h2>
  <table>
    <colgroup>
      <col style="width: 16%" />
  ...
  <ul>
    <li>
      <p><code>@staticmethod</code>: método
        <strong>independiente</strong>, solo usa los parámetros que se le
        pasen.
      </p>
    </li>
    <li>
      <p><code>@classmethod</code>: método <strong>ligado a la
          clase</strong>, puede <strong>usar o modificar atributos de la
          clase</strong> y se puede llamar sin crear una instancia.</p>
    </li>
  </ul>
  <hr />
  <p><a href="./../readme.md#5-python">Regresar a la Guía
