  ...
  return (
    <>
      ...
      <div className="sourceCode" id="cb8">
        <pre
          className="sourceCode python"><code className="sourceCode python"><span id="cb8-1"><Enlace href="#cb8-1" aria-hidden="true" tabindex="-1"></Enlace >numeros <span className="op">=</span> {<span className="dv">1</span>, <span className="dv">2</span>, <span className="dv">3</span>, <span className="dv">3</span>}</span>
      ...
      <div className="sourceCode" id="cb9">
        <pre
          className="sourceCode python"><code className="sourceCode python"><span id="cb9-1"><Enlace href="#cb9-1" aria-hidden="true" tabindex="-1"></Enlace >persona <span className="op">=</span> {<span className="st">&quot;nombre&quot;</span>: <span className="st">&quot;Francisco&quot;</span>, <span className="st">&quot;edad&quot;</span>: <span className="dv">17</span>}</span>
      ...
      <div className="sourceCode" id="cb10">
        <pre
          className="sourceCode python"><code className="sourceCode python"><span id="cb10-1"><Enlace href="#cb10-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="kw">def</span> saludar(nombre):</span>
            <span id="cb10-2"><Enlace href="#cb10-2" aria-hidden="true" tabindex="-1"></Enlace >    <span className="cf">return</span> <span className="ss">f&quot;Hola, </span><span className="sc">{</span>nombre<span className="sc">}</span><span className="ss">&quot;</span></span>
            <span id="cb10-3"><Enlace href="#cb10-3" aria-hidden="true" tabindex="-1"></Enlace ></span>
            <span id="cb10-4"><Enlace href="#cb10-4" aria-hidden="true" tabindex="-1"></Enlace ><span className="bu">print</span>(saludar(<span className="st">&quot;Francisco&quot;</span>))</span></code></pre>
      </div>
      <Linea />
      ...
      <div className="sourceCode" id="cb11">
        <pre className="sourceCode python"><code className="sourceCode python"><span id="cb11-1"><Enlace href="#cb11-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="kw">class</span> Persona:</span>
          ...
          <span id="cb11-7"><Enlace href="#cb11-7" aria-hidden="true" tabindex="-1"></Enlace >        <span className="bu">print</span>(<span className="ss">f&quot;Hola, soy </span><span className="sc">{</span><span className="va">self</span><span className="sc">.</span>nombre<span className="sc">}</span><span className="ss">&quot;</span>)</span>
