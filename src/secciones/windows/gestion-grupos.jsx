...
<head>
  ...
  <title>gestion-grupos</title>

</head>

<body>
  <h1 id="comandos-y-cmdlets-de-grupos">Comandos y cmdlets de grupos</h1>
  <hr />
  ...
  <p><a href="./../readme.md#3-windows">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="comandos-de-gestión-de-grupos-en-cmd">1. Comandos de gestión de
    grupos en CMD</h2>
  <blockquote>
    <p>Todos estos comandos se ejecutan en <strong>Símbolo del sistema
        (CMD)</strong> con permisos de administrador.</p>
  </blockquote>
  <table>
    <colgroup>
      <col style="width: 33%" />
  ...
  <hr />
  <h2 id="cmdlets-de-gestión-de-grupos-en-powershell">2. Cmdlets de
    gestión de grupos en PowerShell</h2>
  <blockquote>
    <p>Estos cmdlets pertenecen al módulo
  ...
  <hr />
  <h3 id="grupos-de-dominio-active-directory">Grupos de dominio (Active
    Directory)</h3>
  <p><em>(solo si tienes instalado el módulo <code>ActiveDirectory</code>
      y estás en un dominio)</em></p>
  <table>
    <colgroup>
      <col style="width: 13%" />
      <col style="width: 29%" />
  ...
  <hr />
  <h2 id="comparativa-cmd-vs-powershell">3. Comparativa CMD vs
    PowerShell</h2>
  <table>
    <colgroup>
      <col style="width: 17%" />
  ...
  <hr />
  <h2 id="atajos-y-comandos-gráficos">4. Atajos y comandos gráficos</h2>
  <table>
    <colgroup>
      <col style="width: 33%" />
      <col style="width: 66%" />
