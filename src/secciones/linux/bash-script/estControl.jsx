  ...
  return (
    <>
      <Estructura>
        ...
        <Codigo code={`for fruta in manzana mango pera; do
...
echo "Contando: $i"
        ...
        <Codigo code={`for (( j=10; j>=5; j-- )) do
echo "Cuenta regresiva: $j"
done`} language="bash" />
        <blockquote>
          <Texto>Esta forma usa la sintaxis tradicional tipo C:</Texto>
          <Codigo code={`for (( inicialización; condición; incremento ))`} language="bash" />
        </blockquote>
        <Linea />
...
((i++))
        ...
        <Codigo code={`while read line; do
echo "- $line"
