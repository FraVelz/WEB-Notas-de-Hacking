...
<body>
  <h1 id="threading-en-python">Threading en Python</h1>
  <hr />
  ...
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-threading">1) ¿Qué es threading?</h2>
  <p><code>threading</code> es el módulo estándar de Python para
  ...
  <hr />
  <h2 id="crear-y-usar-hilos-ejemplos-básicos">3) Crear y usar hilos —
    ejemplos básicos</h2>
  <h3 id="a-usando-thread-con-target">a) Usando Thread con target</h3>
...
<span id="cb2-18"><a href="#cb2-18" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(<span class="st">&quot;Todos terminados&quot;</span>)</span></code></pre>
  ...
  <h3 id="b-subclassing-lhread">b) Subclassing lhread</h3>
...
<span id="cb3-15"><a href="#cb3-15" aria-hidden="true" tabindex="-1"></a>h.join()</span></code></pre>
  ...
  <hr />
  <h2 id="daemon-threads-y-uso-correcto">4) Daemon threads y uso
    correcto</h2>
...
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true" tabindex="-1"></a><span class="co"># Si el main thread termina, el hilo daemon se termina abruptamente.</span></span></code></pre>
  ...
  <p>Usa daemon para tareas de fondo opcionales (logs en tiempo real,
    watchers). Para trabajo crítico, <strong>no</strong> uses daemon;
    asegúrate de <code>join()</code>.</p>
  <hr />
  <h2 id="sincronización-primitivas-importantes">5) Sincronización —
    primitivas importantes</h2>
...
<span id="cb5-4"><a href="#cb5-4" aria-hidden="true" tabindex="-1"></a>    <span class="cf">pass</span></span></code></pre>
  ...
  <h3 id="rlock-reentrant-lock-permite-re-entradas-desde-mismo-hilo">RLock
    (reentrant lock) — permite re-entradas desde mismo hilo</h3>
  ...
  <h3 id="event-señalización-simple-flag">Event — señalización simple
    (flag)</h3>
...
<span id="cb7-6"><a href="#cb7-6" aria-hidden="true" tabindex="-1"></a>event.<span class="bu">set</span>()</span></code></pre>
  ...
  <h3 id="condition-esperas-con-notificación">Condition — esperas con
    notificación</h3>
...
<span id="cb8-5"><a href="#cb8-5" aria-hidden="true" tabindex="-1"></a>    cond.notify()</span></code></pre>
  ...
  <h3 id="semaphore-contador">Semaphore — contador</h3>
...
<span id="cb9-4"><a href="#cb9-4" aria-hidden="true" tabindex="-1"></a>    <span class="cf">pass</span></span></code></pre>
  ...
  <h3 id="barrier-sincronizar-n-hilos-en-un-punto">Barrier — sincronizar N
    hilos en un punto</h3>
...
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true" tabindex="-1"></a>bar.wait()  <span class="co"># todos los hilos esperan aquí hasta que lleguen los 3</span></span></code></pre>
  ...
  <hr />
  <h2 id="comunicación-segura-entre-hilos-queue.queue">6) Comunicación
    segura entre hilos: queue.Queue</h2>
  <p><code>queue.Queue</code> es <strong>thread-safe</strong> y la forma
    recomendada para pasar datos entre hilos (producer-consumer).</p>
...
<span id="cb11-23"><a href="#cb11-23" aria-hidden="true" tabindex="-1"></a>t1.join()<span class="op">;</span> q.join()</span></code></pre>
  ...
  <hr />
  <h2 id="manejo-de-excepciones-en-hilos">7) Manejo de excepciones en
    hilos</h2>
  <p>Las excepciones en <code>Thread</code> no se propagan al hilo
    principal. Opciones:</p>
  <ul>
...
<span id="cb12-14"><a href="#cb12-14" aria-hidden="true" tabindex="-1"></a>            <span class="bu">print</span>(<span class="st">&quot;error en hilo:&quot;</span>, e)</span></code></pre>
  ...
  <hr />
  <h2 id="threadpoolexecutor-alta-abstracción">8) ThreadPoolExecutor (alta
    abstracción)</h2>
  <p>Más cómodo que crear hilos manualmente.</p>
...
<span id="cb13-9"><a href="#cb13-9" aria-hidden="true" tabindex="-1"></a>        <span class="bu">print</span>(f.result())</span></code></pre>
  ...
  <hr />
  <h2 id="gil-cuándo-usar-threading-vs-multiprocessing">9) GIL — cuándo
    usar threading vs multiprocessing</h2>
  <ul>
  ...
  <hr />
  <h2 id="operaciones-atómicas-y-seguridad">10) Operaciones atómicas y
    seguridad</h2>
  <ul>
...
<span id="cb14-6"><a href="#cb14-6" aria-hidden="true" tabindex="-1"></a>        counter <span class="op">+=</span> <span class="dv">1</span>  <span class="co"># no es atómico: leer-modificar-escribir</span></span></code></pre>
  ...
  <p>Siempre protege con <code>Lock</code> si hay acceso concurrente.</p>
  <hr />
  <h2 id="cancelación-y-parada-de-hilos">11) Cancelación y parada de
    hilos</h2>
  <p>No existe <code>Thread.kill()</code> seguro. Patrones para parar:</p>
  <ul>
...
<span id="cb15-9"><a href="#cb15-9" aria-hidden="true" tabindex="-1"></a>stop_event.<span class="bu">set</span>()</span></code></pre>
  ...
  <hr />
  <h2 id="thread-local-storage">12) Thread-local storage</h2>
  <p>Datos separados por hilo:</p>
...
<span id="cb16-9"><a href="#cb16-9" aria-hidden="true" tabindex="-1"></a>t1.start()<span class="op">;</span> t2.start()</span></code></pre>
  ...
  <p>Cada hilo ve su propio <code>local.x</code>.</p>
  <hr />
  <h2 id="debugging-y-utilidades">13) Debugging y utilidades</h2>
  <ul>
...
<span id="cb17-9"><a href="#cb17-9" aria-hidden="true" tabindex="-1"></a>t.start()<span class="op">;</span> t.join()</span></code></pre>
  ...
  <hr />
  <h2 id="buenas-prácticas">14) Buenas prácticas</h2>
  <ul>
  ...
  <hr />
  <h2 id="ejemplos-prácticos-útiles">15) Ejemplos prácticos (útiles)</h2>
  <h3 id="a-producer-consumer-con-queue-resumen">a) Producer-consumer con
    Queue (resumen)</h3>
  <p>Ya mostrado en la sección de Queue. Es el patrón más útil y seguro
    para comunicación.</p>
  <h3 id="b-pool-de-threads-simple-con-thread-y-queue">b) Pool de threads
    simple con Thread y Queue</h3>
...
<span id="cb18-29"><a href="#cb18-29" aria-hidden="true" tabindex="-1"></a>    t.join()</span></code></pre>
  ...
  <h3 id="c-uso-real-con-requests-io-bound">c) Uso real con requests
    (I/O-bound)</h3>
...
<span id="cb19-12"><a href="#cb19-12" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(results)</span></code></pre>
  ...
  <hr />
  <h2 id="limitaciones-y-alternativas">16) Limitaciones y
    alternativas</h2>
  <ul>
    <li>
      <p><code>threading</code> no es la mejor opción para CPU-bound por
        el GIL.</p>
    </li>
    <li>
      <p>Alternativas:</p>
      <ul>
        <li>
          <p><code>multiprocessing</code> — procesos (paralelismo
            real).</p>
        </li>
        <li>
          <p><code>asyncio</code> — concurrencia en un solo hilo usando
            corutinas (muy eficiente para I/O con muchas conexiones).</p>
        </li>
        <li>
          <p><code>concurrent.futures.ProcessPoolExecutor</code> — API
            parecida a ThreadPool pero con procesos.</p>
        </li>
      </ul>
    </li>
  </ul>
  <hr />
  <h2 id="resumen">17) Resumen</h2>
  <ul>
