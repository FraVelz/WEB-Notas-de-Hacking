...
description: Gestion Usuarios - Notas de hacking y ciberseguridad.
---
...
<blockquote>
Estos cmdlets forman parte de los módulos **Microsoft.PowerShell.LocalAccounts** o **ActiveDirectory** (sí está instalado).
...
### Active Directory (solo sí tienes AD instalado) {#active-directory-solo-sí-tienes-ad-instalado}
<!-- Tabla convertida manualmente -->
