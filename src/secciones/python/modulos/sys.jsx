...
<body>
  <h1 id="sys-en-python">Sys en Python</h1>
  <hr />
  ...
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-sys">¿Qué es sys?</h2>
  <p><code>sys</code> es un módulo integrado que ofrece <strong>interfaz
  ...
  <h2 id="uso-básico-y-más-común">Uso básico y más común</h2>
  <h3 id="sys.argv">sys.argv</h3>
  <p>Lista de argumentos pasados al script (el elemento 0 es el nombre del
    script).</p>
...
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a><span class="co"># Ejecuta: python ejemplo.py a b -&gt; [&#39;ejemplo.py&#39;, &#39;a&#39;, &#39;b&#39;]</span></span></code></pre>
  ...
  <h3 id="sys.exitcodemessage">sys.exit([code|message])</h3>
  <p>Termina el intérprete lanzando <code>SystemExit</code>.
...
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true" tabindex="-1"></a>    sys.exit(<span class="st">&quot;falta argumento&quot;</span>)</span></code></pre>
  ...
  <p>Lista de rutas donde Python busca módulos. Puedes modificarla en
    tiempo de ejecución (útil para scripts).</p>
...
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true" tabindex="-1"></a>sys.path.append(<span class="st">&quot;/mi/carpeta/lib&quot;</span>)</span></code></pre>
  ...
  <p>Diccionario de módulos cargados en memoria
    (<code>name -&gt; module</code>). Útil para inspección o recarga.</p>
...
<span id="cb5-3"><a href="#cb5-3" aria-hidden="true" tabindex="-1"></a>importlib.<span class="bu">reload</span>(sys.modules[<span class="st">&#39;mi_modulo&#39;</span>])</span></code></pre>
  ...
  <h3 id="sys.stdout-sys.stderr-sys.stdin">sys.stdout, sys.stderr,
    sys.stdin</h3>
  <p>Streams estándar. Permiten redirigir o manipular entrada/salida.</p>
...
<span id="cb6-3"><a href="#cb6-3" aria-hidden="true" tabindex="-1"></a>data <span class="op">=</span> sys.stdin.read()</span></code></pre>
  ...
  <p>También puedes usar <code>sys.stdout.buffer</code> para I/O
    binaria.</p>
  <h3 id="sys.version-y-sys.version_info">sys.version y
    sys.version_info</h3>
  <p>Información de la versión de Python.</p>
...
<span id="cb7-4"><a href="#cb7-4" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(<span class="st">&quot;actualiza python&quot;</span>)</span></code></pre>
  ...
  <h3 id="sys.platform">sys.platform</h3>
  <p>Cadena que indica la plataforma (e.g., <code>'linux'</code>,
...
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(<span class="st">&quot;Windows&quot;</span>)</span></code></pre>
  ...
  <h3 id="sys.maxsize">sys.maxsize</h3>
  <p>Entero que normalmente indica el tamaño máximo práctico de
    estructuras (32/64-bit).</p>
  ...
  <h3 id="sys.getsizeofobj-default">sys.getsizeof(obj[, default])</h3>
  <p>Devuelve el tamaño en bytes del objeto (solo tamaño del objeto, no
    profundidad).</p>
...
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(sys.getsizeof(x))  <span class="co"># tamaño del objeto lista en memoria (superficial)</span></span></code></pre>
  ...
  <h3 id="sys.getrecursionlimit-sys.setrecursionlimitn">sys.getrecursionlimit()
    / sys.setrecursionlimit(n)</h3>
  <p>Leer y ajustar el límite de recursión del intérprete.</p>
...
<span id="cb11-2"><a href="#cb11-2" aria-hidden="true" tabindex="-1"></a>sys.setrecursionlimit(<span class="dv">2000</span>)</span></code></pre>
  ...
  <p>Usar con cuidado: un límite demasiado alto puede provocar
    segfault.</p>
  <h3 id="sys.exc_info">sys.exc_info()</h3>
  <p>Información sobre la excepción actual:
...
<span id="cb12-4"><a href="#cb12-4" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(sys.exc_info())</span></code></pre>
  ...
  <h3 id="sys.excepthook">sys.excepthook</h3>
  <p>Función que maneja excepciones no capturadas. Puedes reemplazarla
    para logging personalizado.</p>
...
<span id="cb13-3"><a href="#cb13-3" aria-hidden="true" tabindex="-1"></a>sys.excepthook <span class="op">=</span> mi_handler</span></code></pre>
  ...
  <h3 id="sys.getdefaultencoding-y-sys.getfilesystemencoding">sys.getdefaultencoding()
    y sys.getfilesystemencoding()</h3>
  <p>Codificaciones por defecto (útil para I/O y compatibilidad entre
    plataformas).</p>
  ...
  <h3 id="sys.byteorder">sys.byteorder</h3>
  <p>Orden de bytes de la máquina: <code>'little'</code> o
    <code>'big'</code>.
  </p>
  ...
  <h3 id="sys.implementation">sys.implementation</h3>
  <p>Información sobre la implementación de Python (CPython, PyPy,
    etc.)</p>
  ...
  <h3 id="sys.flags">sys.flags</h3>
  <p>Namespace con banderas con las que arrancó el intérprete
  ...
  <h3 id="sys.getwindowsversion-solo-windows">sys.getwindowsversion()
    (solo Windows)</h3>
  <p>Disponible solo en Windows; usar
    <code>hasattr(sys, "getwindowsversion")</code> para comprobar.
  </p>
  <h3 id="sys.getswitchinterval-sys.setswitchinterval">sys.getswitchinterval()
    / sys.setswitchinterval()</h3>
  <p>Controla la frecuencia de cambio de contexto entre threads
    (CPython).</p>
  <hr />
  <h2 id="ejemplos-prácticos">Ejemplos prácticos</h2>
  <h3 id="script-que-procesa-cli-simple">1) Script que procesa CLI
    simple</h3>
...
<span id="cb18-13"><a href="#cb18-13" aria-hidden="true" tabindex="-1"></a>    main()</span></code></pre>
  ...
  <h3 id="redirigir-salida-a-un-archivo">2) Redirigir salida a un
    archivo</h3>
...
<span id="cb19-6"><a href="#cb19-6" aria-hidden="true" tabindex="-1"></a>    sys.stdout <span class="op">=</span> old_stdout</span></code></pre>
  ...
  <h3 id="manejo-global-de-excepciones-logging">3) Manejo global de
    excepciones (logging)</h3>
...
<span id="cb20-8"><a href="#cb20-8" aria-hidden="true" tabindex="-1"></a><span class="co"># cualquier excepción no capturada irá a errores.log</span></span></code></pre>
  ...
  <h3 id="comprobar-versión-de-python-antes-de-correr">4) Comprobar
    versión de Python antes de correr</h3>
...
<span id="cb21-3"><a href="#cb21-3" aria-hidden="true" tabindex="-1"></a>    sys.exit(<span class="st">&quot;Este script requiere Python 3.8+&quot;</span>)</span></code></pre>
  ...
  <h2 id="buenas-prácticas-y-advertencias">Buenas prácticas y
    advertencias</h2>
  <ul>
    <li>
      <p><strong>No abuses de <code>sys.path.append()</code></strong> en
        producción; usa paquetes instalables o
        <code>PYTHONPATH</code>/virtualenvs.
      </p>
    </li>
    <li>
      <p><code>sys.getsizeof()</code> da tamaño superficial; para medir
        memoria profunda usa <code>pympler</code> o
        <code>tracemalloc</code>.
      </p>
    </li>
    <li>
      <p>Cambiar el límite de recursión con
        <code>setrecursionlimit()</code> solo si entiendes el riesgo.
      </p>
    </li>
    <li>
      <p><code>sys.exit()</code> en bibliotecas es mala idea: las
        bibliotecas deben lanzar excepciones, no terminar el proceso.</p>
    </li>
    <li>
      <p>Evita escribir directamente a <code>sys.stdout</code> si usas
        frameworks que gestionan I/O (mejor usar logging).</p>
    </li>
  </ul>
  <h2 id="debugging-y-profiling">Debugging y profiling</h2>
  <ul>
    <li>
      <p><code>sys.setrecursionlimit()</code> para debugging de recursión
        (con cuidado).</p>
    </li>
    <li>
      <p>Para profiling de memoria/ejecución usa módulos especializados
        (<code>tracemalloc</code>, <code>profile</code>, <code>cProfile</code>),
        no <code>sys</code> directamente.</p>
    </li>
  </ul>
  <h2 id="mini-proyectos-ejercicios-sugeridos">Mini-proyectos / ejercicios
    sugeridos</h2>
  <ol type="1">
    <li>
      <p>Script CLI con <code>argparse</code> que use
        <code>sys.argv</code> como fallback y registre errores en
        <code>sys.stderr</code>.
      </p>
    </li>
    <li>
      <p>Programa que redirija <code>sys.stdout</code> a un archivo y
        luego restaure la salida normal.</p>
    </li>
    <li>
      <p>Wrapper que compruebe <code>sys.version_info</code> y ejecute un
        comportamiento alterno para versiones antiguas.</p>
    </li>
    <li>
      <p>Logger global usando <code>sys.excepthook</code> para capturar
        excepciones no manejadas.</p>
    </li>
    <li>
      <p>Herramienta que inspeccione <code>sys.modules</code> para listar
        módulos cargados y su ruta (<code>module.__file__</code>).</p>
    </li>
  </ol>
  <hr />
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
