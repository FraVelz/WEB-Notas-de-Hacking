...
<body>
  <h1 id="multiprocessing-en-python">Multiprocessing en Python</h1>
  <hr />
  ...
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-multiprocessing">¿Qué es multiprocessing?</h2>
  <p><code>multiprocessing</code> permite <strong>ejecutar varios procesos
      ...
      Lock)</strong>.</p>
  <p>Es ideal para tareas <strong>pesadas en CPU</strong>, como cálculos,
    IA, simulaciones, etc.</p>
  <hr />
  <h2 id="conceptos-básicos">Conceptos básicos</h2>
  <h3 id="crear-un-proceso">Crear un proceso</h3>
...
<span id="cb1-10"><a href="#cb1-10" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(<span class="st">&quot;Proceso finalizado&quot;</span>)</span></code></pre>
  ...
  <hr />
  <h2 id="enviar-datos-entre-procesos">Enviar datos entre procesos</h2>
  <h3 id="con-queue">Con Queue</h3>
...
<span id="cb3-12"><a href="#cb3-12" aria-hidden="true" tabindex="-1"></a>    p.join()</span></code></pre>
  ...
  <hr />
  <h2 id="uso-de-pool-grupo-de-procesos">Uso de Pool (grupo de
    procesos)</h2>
  <p>Permite ejecutar una función muchas veces en paralelo fácilmente.</p>
...
<span id="cb4-9"><a href="#cb4-9" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(resultados)</span></code></pre>
  ...
  <p>➡️ Ejecuta <code>cuadrado</code> en paralelo para cada valor.</p>
  <hr />
  <h2 id="variables-compartidas">Variables compartidas</h2>
  <p>Para compartir datos entre procesos de forma segura:</p>
  <h3 id="value-y-array">Value y Array</h3>
...
<span id="cb5-13"><a href="#cb5-13" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(v.value, a[:])</span></code></pre>
  ...
  <hr />
  <h2 id="sincronización-entre-procesos">Sincronización entre
    procesos</h2>
  <p>Se usan mecanismos como <code>Lock</code>, <code>Event</code>,
    <code>Semaphore</code>, etc., para evitar conflictos.
  </p>
  <h3 id="ejemplo-con-lock">Ejemplo con Lock</h3>
