...
}`,language:"bash"}),e.jsx(n,{children:e.jsx("strong",{children:"Llamar una función:"})}),e.jsx(l,{code:"mi_funcion",language:"bash"}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"2-parámetros-en-funciones",children:"2. Parámetros en funciones"}),e.jsx(n,{children:"Los argumentos se manejan igual que en un script:"}),e.jsxs(p,{children:[e.jsx(v,{headers:["Variable","Significado"]}),e.jsxs("tbody",{children:[e.jsxs(i,{children:[e.jsx(s,{children:"$1"}),e.jsx(s,{children:"Primer argumento"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$2"}),e.jsx(s,{children:"Segundo argumento"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$@"}),e.jsx(s,{children:"Todos los argumentos"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$#"}),e.jsx(s,{children:"Cantidad de argumentos"})]})]})]}),e.jsx(n,{children:"Ejemplo:"}),e.jsx(l,{code:`saludar() {
echo "Hola $1 $2"
}

saludar "Francisco" "Vélez"
# → Hola Francisco Vélez`,language:"bash"}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"3-devolver-valores",children:"3. Devolver valores"}),e.jsxs(n,{children:["En Bash, return solo devuelve ",e.jsx("strong",{children:"códigos de salida (= éxito, ≠0 = error)"}),". Para devolver datos reales se usa echo y ",e.jsx("strong",{children:"captura de comandos"}),":"]}),e.jsx(l,{code:`sumar() {
echo $(( $1 + $2 ))
}

resultado=$(sumar 5 7)
echo "La suma es: $resultado"
# → La suma es: 12`,language:"bash"}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"4-variables-globales-y-locales",children:"4. Variables Globales y Locales"}),e.jsxs(n,{children:["Por defecto, todas las variables son ",e.jsx("strong",{children:"globales"}),". Para que existan solo dentro de la función, usa local."]}),e.jsx(l,{code:`mensaje="Hola mundo"
...
echo "Antes: $mensaje"
cambiar
echo "Después: $mensaje"`,language:"bash"}),e.jsx(n,{children:e.jsx("strong",{children:"Diferencias clave:"})}),e.jsxs(p,{children:[e.jsx(v,{headers:["Tipo","Alcance","Vida útil"]}),e.jsxs("tbody",{children:[e.jsxs(i,{children:[e.jsx(s,{children:"Global"}),e.jsx(s,{children:"Todo el script"}),e.jsx(s,{children:"Hasta que termina el script"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"Local"}),e.jsx(s,{children:"Solo dentro de la función"}),e.jsx(s,{children:"Se destruye al salir de la función"})]})]})]}),e.jsxs(n,{children:["Usa ",e.jsx("strong",{children:"local"})," para evitar modificar variables globales sin querer."]}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"5-argumentos-en-scripts",children:"5. Argumentos en scripts"}),e.jsx(n,{children:"Cuando ejecutas un script, puedes pasarle argumentos:"}),e.jsx(l,{code:`#!/bin/bash
echo "Hola $1"`,language:"bash"}),e.jsx(n,{children:"Ejecución:"}),e.jsx(l,{code:`bash script.sh Francisco
# → Hola Francisco`,language:"bash"}),e.jsx(n,{children:"Variables especiales:"}),e.jsxs(p,{children:[e.jsx(v,{headers:["Variable","Significado"]}),e.jsxs("tbody",{children:[e.jsxs(i,{children:[e.jsx(s,{children:"$0"}),e.jsx(s,{children:"Nombre del script"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$1, $2..."}),e.jsx(s,{children:"Argumentos individuales"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$#"}),e.jsx(s,{children:"Número de argumentos"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$@"}),e.jsx(s,{children:"Todos los argumentos como lista"})]}),e.jsxs(i,{children:[e.jsx(s,{children:"$*"}),e.jsx(s,{children:"Todos los argumentos como una sola cadena"})]})]})]}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"6-validaciones-útiles",children:"6. Validaciones útiles"}),e.jsx(n,{children:e.jsx("strong",{children:"Validar número de argumentos:"})}),e.jsx(l,{code:`if [ $# -ne 2 ]; then
...
exit 1
fi`,language:"bash"}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"7-recorrer-argumentos",children:"7. Recorrer argumentos"}),e.jsx(a,{title:"h3",id:"con-for",children:"Con for"}),e.jsx(l,{code:`for arg in "$@"; do
echo "Argumento: $arg"
...
echo "Actual: $1"
shift
done`,language:"bash"}),e.jsx(n,{children:"shift 2 eliminaría los dos primeros argumentos de golpe."}),e.jsx(o,{}),e.jsx(a,{title:"h2",id:"8-ejemplo-práctico-mini-calculadora",children:"8. Ejemplo práctico: mini calculadora"}),e.jsx(l,{code:`#!/bin/bash
