...
- El usuario invoca **`/problems-search`** o pide una **búsqueda / auditoría global** de problemas que puedan afectar la documentación o el despliegue.
...
Considerar siempre el **impacto en producción** (lectores, SEO, build/CI, GitHub Pages, enlaces rotos, accesibilidad del contenido) y la **probabilidad** de que el problema ocurra en el sitio desplegado.
...
- **Config Astro**: `astro.config.mjs` — `output: 'static'`, `base: '/WEB-Notas-de-Hacking'`, `site: 'https://fravelz.github.io'`.
...
- **`starlight-sidebar.mjs`**: slugs alineados con archivos en `src/content/docs/`; páginas en sidebar sin archivo o archivos huérfanos.
...
- Consistencia técnica del contenido (comandos, versiones de herramientas desactualizadas) — marcar como P2/P3 salvo error grave.
