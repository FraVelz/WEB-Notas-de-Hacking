  ...
  return (
    <Lista className={className}>
      <li><Enlace href="#1-gestión-de-usuarios">1. Gestión de usuarios</Enlace >
        <Lista>
          <li><Enlace href="#useradd-vs-adduser"><code>useradd</code> vs
            <code>adduser</code></Enlace >
            <Lista>
              <li><Enlace href="#1-useradd-programa-básico-del-sistema">1.
                <code>useradd</code> (programa básico del sistema)</Enlace ></li>
              <li><Enlace href="#2-adduser-script-de-alto-nivel">2. <code>adduser</code>
    ...
    <>
      <Estructura>
        ...
        <div className="sourceCode" id="cb1">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb1-1"><Enlace href="#cb1-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> useradd francisco</span></code></pre>
        </div>
        ...
        <div className="sourceCode" id="cb2">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb2-1"><Enlace href="#cb2-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> mkdir /home/francisco</span>
              <span id="cb2-2"><Enlace href="#cb2-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> cp <span className="at">-r</span> /etc/skel/. /home/francisco</span>
              <span id="cb2-3"><Enlace href="#cb2-3" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> chown <span className="at">-R</span> francisco:francisco /home/francisco</span>
              <span id="cb2-4"><Enlace href="#cb2-4" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> passwd francisco</span></code></pre>
        </div>
        ...
        <div className="sourceCode" id="cb3">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb3-1"><Enlace href="#cb3-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> adduser francisco</span></code></pre>
        </div>
        <Texto>Esto:</Texto>
        <Lista>
        ...
        <div className="sourceCode" id="cb4">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb4-1"><Enlace href="#cb4-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">juan</span></span>
              <span id="cb4-2"><Enlace href="#cb4-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">maria</span></span>
              <span id="cb4-3"><Enlace href="#cb4-3" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">pedro</span></span></code></pre>
        </div>
        ...
        <div className="sourceCode" id="cb5">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb5-1"><Enlace href="#cb5-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> groupadd proyecto</span></code></pre>
        </div>
        <Texto>Luego agregas a los usuarios al grupo:</Texto>
        <div className="sourceCode" id="cb6">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb6-1"><Enlace href="#cb6-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-aG</span> proyecto juan</span>
              <span id="cb6-2"><Enlace href="#cb6-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-aG</span> proyecto maria</span></code></pre>
        </div>
        <Texto>Después haces que la carpeta pertenezca a ese grupo:</Texto>
        <div className="sourceCode" id="cb7">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb7-1"><Enlace href="#cb7-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> chown :proyecto /proyecto</span></code></pre>
        </div>
        <Texto>Y le das permisos solo al grupo:</Texto>
        <div className="sourceCode" id="cb8">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb8-1"><Enlace href="#cb8-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> chmod 770 /proyecto</span></code></pre>
        </div>
        <Texto>Ahora:</Texto>
        <Lista>
        ...
        <ol type="1">
          <li><strong>Un grupo principal (primario):</strong> Se crea
            ...
            <div className="sourceCode" id="cb9">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb9-1"><Enlace href="#cb9-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-aG</span> sudo,video,audio francisco</span></code></pre>
            </div>
        ...
        <div className="sourceCode" id="cb10">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb10-1"><Enlace href="#cb10-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">groups</span> francisco</span></code></pre>
        </div>
        <Texto>Salida posible:</Texto>
        <div className="sourceCode" id="cb11">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb11-1"><Enlace href="#cb11-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">francisco</span> : francisco sudo video audio</span></code></pre>
        </div>
        ...
        <Lista>
          <li>
            ...
            <div className="sourceCode" id="cb12">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb12-1"><Enlace href="#cb12-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">root:x:0:</span></span>
                  <span id="cb12-2"><Enlace href="#cb12-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">sudo:x:27:francisco</span></span>
                  <span id="cb12-3"><Enlace href="#cb12-3" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">proyecto:x:1002:juan,maria</span></span></code></pre>
            </div>
          </li>
        </Lista>
        ...
        <Lista>
          <li>
            ...
            <div className="sourceCode" id="cb13">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb13-1"><Enlace href="#cb13-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> useradd <span className="at">-m</span> <span className="at">-s</span> /bin/bash francisco</span></code></pre>
            </div>
          </li>
          <li>
            ...
            <div className="sourceCode" id="cb14">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb14-1"><Enlace href="#cb14-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-l</span> nuevo_nombre francisco</span></code></pre>
            </div>
          </li>
          <li>
            ...
            <div className="sourceCode" id="cb15">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb15-1"><Enlace href="#cb15-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-L</span> francisco    <span className="co"># Bloquear</span></span>
                  <span id="cb15-2"><Enlace href="#cb15-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> usermod <span className="at">-U</span> francisco    <span className="co"># Desbloquear</span></span></code></pre>
            </div>
          </li>
          <li>
            ...
            <div className="sourceCode" id="cb16">
              <pre
                className="sourceCode bash"><code className="sourceCode bash"><span id="cb16-1"><Enlace href="#cb16-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">cut</span> <span className="at">-d:</span> <span className="at">-f1</span> /etc/passwd</span></code></pre>
            </div>
          </li>
        </Lista>
        <Linea />
        ...
        <div className="sourceCode" id="cb17">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb17-1"><Enlace href="#cb17-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">root</span>       → superusuario</span>
              <span id="cb17-2"><Enlace href="#cb17-2" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">mysql</span>      → usuario del servicio MySQL</span>
              <span id="cb17-3"><Enlace href="#cb17-3" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">www-data</span>   → usuario del servidor web Apache o Nginx</span>
              <span id="cb17-4"><Enlace href="#cb17-4" aria-hidden="true" tabindex="-1"></Enlace ><span className="ex">nobody</span>     → usuario “vacío” usado por procesos sin privilegios</span></code></pre>
        </div>
        ...
        <div className="sourceCode" id="cb18">
          <pre
            className="sourceCode bash"><code className="sourceCode bash"><span id="cb18-1"><Enlace href="#cb18-1" aria-hidden="true" tabindex="-1"></Enlace ><span className="fu">sudo</span> useradd <span className="at">-r</span> <span className="at">-s</span> /bin/false servidor_web</span></code></pre>
        </div>
