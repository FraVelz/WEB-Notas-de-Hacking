...
<head>
  ...
  <title>googleDoorks</title>

</head>

<body>
  <h1 id="google-doorks">Google Doorks</h1>
  <p><a href="./../readme.md#7-osint">Regresar a la guía principal</a></p>
  <h2 id="qué-es">¿Qué es?</h2>
  <p>Es una técnica de búsqueda avanzada en Google, para poder conocer
    información concreta a base de poder ir aplicando filtros en los
    resultados, operadores conocidos como dorks.</p>
  <h2 id="operadores-dorks">Operadores dorks</h2>
  <p>Nota el asterisco (*) dice que cualquier palabra puede pasar el
  ...
  <p>Esto apunta a todas las páginas que empiezan por reddit sin importar
    como termine, pueden terminal por ejemplo reddit.us, reddit.arg,
    reddit.paypal, o reddit.store, etc…</p>
  <p>También otra consideración es que puedes utilizar no solo palabra en
  ...
  <p>Es importante tener en cuenta que todos estos operadores están
    escritos de la manera:</p>
  ...
  <p>Sin espacios a menos que se usen comillas dobles, pero todo lo que
  ...
  <p>En este caso buscara <strong>préstamos sin intereses</strong>, y
  ...
  <p>Con lo anterior se puede hacer búsquedas en Google con filtros, y
    ...
    puede doxear o hackear porque la web no tiene el protocolo https.</p>
  <p>En la página web de Google hacking data base, puedes encontrar
    operadores dorks especializados para búsquedas que se llegan, a tener o
    usar, para la ciberseguridad.</p>
  <p><a href="./../readme.md#7-osint">Regresar a la guía principal</a></p>
  <blockquote>
