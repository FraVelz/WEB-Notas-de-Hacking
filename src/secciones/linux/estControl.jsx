...
<head>
  ...
  <title>estControl</title>

</head>

<body>
  <h1 id="estructuras-de-control-en-bash-script">Estructuras de Control en
    Bash Script</h1>
  <p>Este documento explica cómo usar <strong>bucles</strong>,
  ...
  <p><a href="./../readme.md#2-linux-y-bash-script">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="bucle-for">Bucle <code>for</code></h2>
  <p>El bucle <code>for</code> permite ejecutar una serie de comandos
    repetidamente para una lista de valores o rangos numéricos.</p>
  <p><strong>Ejemplo 1: Lista de elementos:</strong></p>
...
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <blockquote>
    <p>Recorre una lista de palabras (en este caso, frutas) y ejecuta el
      bloque <code>do ... done</code> para cada elemento.</p>
  </blockquote>
  <p><strong>Ejemplo 2: Rango de números:</strong></p>
...
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <blockquote>
    <p><code>{1..3}</code> genera una secuencia del 1 al 3.</p>
  </blockquote>
  <p><strong>Ejemplo 3: Sintaxis estilo C</strong></p>
...
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <blockquote>
    <p>Esta forma usa la sintaxis tradicional tipo C:</p>
  ...
  <hr />
  <h2 id="bucle-while">Bucle <code>while</code></h2>
  <p>Ejecuta un bloque de código <strong>mientras una condición sea
      verdadera</strong>.</p>
...
<span id="cb5-6"><a href="#cb5-6" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <blockquote>
    <p>En este ejemplo, el bucle incrementa <code>i</code> desde 0 hasta que
      ya no sea menor que 3.</p>
  </blockquote>
  <p><strong>Leer líneas desde un archivo:</strong></p>
  <p>Puedes usar <code>while</code> junto con <code>read</code> para leer
    archivos línea por línea.</p>
...
<span id="cb6-3"><a href="#cb6-3" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span> <span class="op">&lt;</span> archivo.txt</span></code></pre>
  ...
  <blockquote>
    <p>Esto imprimirá cada línea del archivo precedida por un guion.</p>
  </blockquote>
  <hr />
  <h2 id="bucle-until">Bucle <code>until</code></h2>
  <p>El bucle <code>until</code> funciona igual que <code>while</code>,
    pero <strong>se ejecuta mientras la condición sea falsa</strong>.</p>
...
<span id="cb7-7"><a href="#cb7-7" aria-hidden="true" tabindex="-1"></a><span class="st">&#39;</span></span></code></pre>
  ...
  <blockquote>
    <p>En este ejemplo, el bucle incrementa <code>i</code> desde 1 hasta
      5.</p>
  </blockquote>
  <hr />
  <h2 id="comandos-continue-y-break">Comandos <code>continue</code> y
    <code>break</code>
  </h2>
  <p>Los comandos <code>continue</code> y <code>break</code> sirven para
...
<span id="cb8-19"><a href="#cb8-19" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <blockquote>
    <p><code>break n</code> rompe <code>n</code> niveles de bucles
      anidados.<br />
      <code>continue</code> salta directamente a la siguiente iteración.
    </p>
  </blockquote>
  <hr />
  <h2 id="estructura-case">Estructura <code>case</code></h2>
  <p>La estructura <code>case</code> permite comparar una variable con
...
<span id="cb9-13"><a href="#cb9-13" aria-hidden="true" tabindex="-1"></a><span class="cf">esac</span></span></code></pre>
  ...
  <blockquote>
    <p>Cada bloque se cierra con <code>;;</code> y el comodín <code>*</code>
      actúa como <strong>caso por defecto</strong>.</p>
  </blockquote>
  <hr />
  <p><a href="./../readme.md#2-linux-y-bash-script">Regresar a la guía
      principal</a></p>
