...
<head>
  ...
  <title>alias-powershell</title>

</head>

<body>
  <h1 id="alias-en-powershell">Alias en powershell</h1>
  <hr />
  ...
  <p><a href="./../readme.md#3-windows">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="qué-es-un-alias">Qué es un alias</h2>
  <p>Un <strong>alias</strong> es simplemente un <strong>nombre
      alternativo</strong> para un comando existente. Por ejemplo:</p>
...
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true" tabindex="-1"></a><span class="fu">ls</span>                <span class="co"># Alias</span></span></code></pre>
  ...
  <p>Ambos hacen lo mismo: listar archivos y carpetas.</p>
  <hr />
  <h2 id="alias-comunes-en-powershell">Alias comunes en PowerShell</h2>
  <table>
    <colgroup>
      <col style="width: 19%" />
      <col style="width: 17%" />
  ...
  <hr />
  <h2 id="cmdlets-relacionados-con-alias">Cmdlets relacionados con
    alias</h2>
  <table>
    <colgroup>
      <col style="width: 28%" />
...
<span id="cb2-14"><a href="#cb2-14" aria-hidden="true" tabindex="-1"></a><span class="fu">Remove-Item</span> alias<span class="op">:</span>editar</span></code></pre>
  ...
  <hr />
  <h2 id="alias-persistentes">Alias persistentes</h2>
  <p>Por defecto, los alias creados con <code>Set-Alias</code> o
    <code>New-Alias</code> <strong>solo duran mientras PowerShell está
      abierto</strong>.
  </p>
  <p>Para hacerlos <strong>permanentes</strong>, agrégalos al
  ...
  <p>Luego agrega tus alias personalizados:</p>
...
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true" tabindex="-1"></a><span class="fu">Set-Alias</span> borrar <span class="fu">Remove-Item</span></span></code></pre>
  ...
  <p>Guarda el archivo y la próxima vez que abras PowerShell, estarán
    disponibles.</p>
  <hr />
  <h2 id="nota-importante">Nota importante</h2>
  <ul>
    <li>
      <p>Los alias <strong>no aceptan parámetros por defecto</strong>. Por
        ejemplo, <code>Set-Alias buscar "Get-ChildItem -Recurse"</code> ❌ no
        funcionará. En ese caso, usa una <strong>función</strong>:</p>
