...
<body>
  <h1 id="comandos-y-cmdlets-de-gestión-de-usuarios">Comandos y cmdlets de
  ...
  <p><a href="./../readme.md#3-windows">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="comandos-de-gestión-de-usuarios-en-cmd">1. Comandos de gestión
    de usuarios en CMD</h2>
  <blockquote>
    <p>Estos comandos funcionan directamente desde <strong>Símbolo del
        sistema (cmd)</strong> con permisos de administrador.</p>
  </blockquote>
  <table>
    <colgroup>
      <col style="width: 23%" />
  ...
  <hr />
  <h2 id="cmdlets-de-gestión-de-usuarios-en-powershell">2. Cmdlets de
    gestión de usuarios en PowerShell</h2>
  <blockquote>
    <p>Estos cmdlets forman parte de los módulos
      <strong>Microsoft.PowerShell.LocalAccounts</strong> o
      <strong>ActiveDirectory</strong> (si está instalado).
    </p>
  </blockquote>
  <h3 id="usuarios-locales">Usuarios locales</h3>
  <table>
    <colgroup>
      <col style="width: 13%" />
      <col style="width: 28%" />
  ...
  <hr />
  <h3 id="grupos-locales">Grupos locales</h3>
  <table>
    <colgroup>
      <col style="width: 17%" />
      <col style="width: 29%" />
  ...
  <hr />
  <h3 id="información-y-autenticación">Información y autenticación</h3>
  <table>
    <colgroup>
      <col style="width: 41%" />
      <col style="width: 35%" />
  ...
  <hr />
  <h3 id="active-directory-solo-si-tienes-ad-instalado">Active Directory
    (solo si tienes AD instalado)</h3>
  <table>
    <colgroup>
      <col style="width: 9%" />
      <col style="width: 24%" />
  ...
  <hr />
  <h2 id="comandos-útiles-para-entornos-mixtos-cmd-powershell">3. Comandos
    útiles para entornos mixtos (CMD + PowerShell)</h2>
  <table>
    <colgroup>
      <col style="width: 20%" />
      <col style="width: 32%" />
