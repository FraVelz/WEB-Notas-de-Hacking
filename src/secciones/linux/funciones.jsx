...
<body>
  <h1 id="funciones-variables-y-argumentos-en-bash-script">Funciones,
    Variables y Argumentos en Bash Script</h1>
  <p>Este documento explica como usar <strong>funciones</strong>,
  ...
  <p><a href="./../readme.md#2-linux-y-bash-script">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="definición-de-funciones">1. Definición de funciones</h2>
  <p>En Bash, una función agrupa comandos que puedes reutilizar. Existen
    dos formas equivalentes:</p>
...
<span id="cb1-9"><a href="#cb1-9" aria-hidden="true" tabindex="-1"></a><span class="kw">}</span></span></code></pre>
  ...
  <p><strong>Llamar una función:</strong></p>
  ...
  <hr />
  <h2 id="parámetros-en-funciones">2. Parámetros en funciones</h2>
  <p>Los argumentos se manejan igual que en un script:</p>
  <table>
    <thead>
      <tr>
        <th>Variable</th>
...
<span id="cb3-6"><a href="#cb3-6" aria-hidden="true" tabindex="-1"></a><span class="co"># → Hola Francisco Vélez</span></span></code></pre>
  ...
  <hr />
  <h2 id="devolver-valores">3. Devolver valores</h2>
  <p>En Bash, <code>return</code> solo devuelve <strong>códigos de salida
...
<span id="cb4-7"><a href="#cb4-7" aria-hidden="true" tabindex="-1"></a><span class="co"># → La suma es: 12</span></span></code></pre>
  ...
  <hr />
  <h2 id="variables-globales-y-locales">4. Variables Globales y
    Locales</h2>
  <p>Por defecto, todas las variables son <strong>globales</strong>. Para
    que existan solo dentro de la función, usa <code>local</code>.</p>
...
<span id="cb5-10"><a href="#cb5-10" aria-hidden="true" tabindex="-1"></a><span class="bu">echo</span> <span class="st">&quot;Después: </span><span class="va">$mensaje</span><span class="st">&quot;</span></span></code></pre>
  ...
  <p>Usa <strong><code>local</code></strong> para evitar modificar
    variables globales sin querer.</p>
  <hr />
  <h2 id="argumentos-en-scripts">5. Argumentos en scripts</h2>
  <p>Cuando ejecutas un script, puedes pasarle argumentos:</p>
...
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true" tabindex="-1"></a><span class="co"># → Hola Francisco</span></span></code></pre>
  ...
  <hr />
  <h2 id="validaciones-útiles">6. Validaciones útiles</h2>
  <p><strong>Validar número de argumentos:</strong></p>
...
<span id="cb8-4"><a href="#cb8-4" aria-hidden="true" tabindex="-1"></a><span class="cf">fi</span></span></code></pre>
  ...
  <p><strong>Validar argumento vacío:</strong></p>
...
<span id="cb9-4"><a href="#cb9-4" aria-hidden="true" tabindex="-1"></a><span class="cf">fi</span></span></code></pre>
  ...
  <p><strong>Validar que sea un número:</strong></p>
...
<span id="cb10-4"><a href="#cb10-4" aria-hidden="true" tabindex="-1"></a><span class="cf">fi</span></span></code></pre>
  ...
  <hr />
  <h2 id="recorrer-argumentos">7. Recorrer argumentos</h2>
  <h3 id="con-for">Con <code>for</code></h3>
...
<span id="cb11-3"><a href="#cb11-3" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <h3 id="con-shift">Con <code>shift</code></h3>
  <p><code>shift</code> elimina el primer argumento (<code>$1</code>) y
    mueve los demás a la izquierda.</p>
...
<span id="cb12-4"><a href="#cb12-4" aria-hidden="true" tabindex="-1"></a><span class="cf">done</span></span></code></pre>
  ...
  <p><code>shift 2</code> eliminaría los dos primeros argumentos de
    golpe.</p>
  <hr />
  <h2 id="ejemplo-práctico-mini-calculadora">8. Ejemplo práctico: mini
    calculadora</h2>
