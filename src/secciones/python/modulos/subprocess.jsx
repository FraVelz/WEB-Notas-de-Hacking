...
<body>
  ...
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-subprocess">¿Qué es subprocess?</h2>
...
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true" tabindex="-1"></a>subprocess.run([<span class="st">&quot;ls&quot;</span>])</span></code></pre>
  ...
  <p>👉 Ejecuta el comando <code>ls</code> (en Linux/Mac) igual que si lo
  ...
  <hr />
  <h2 id="ejecutar-comandos-básicos">2. Ejecutar comandos básicos</h2>
...
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a>subprocess.run([<span class="st">&quot;echo&quot;</span>, <span class="st">&quot;Hola desde Python!&quot;</span>])</span></code></pre>
  ...
  <p>También puedes pasar <code>shell=True</code> (aunque menos
    seguro):</p>
...
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(<span class="st">&quot;Salida:&quot;</span>, resultado.stdout)</span></code></pre>
  ...
  <h3 id="atributos-útiles">Atributos útiles</h3>
  <ul>
  ...
  <p>Si quieres que el programa <strong>lance una excepción</strong>
...
<span id="cb5-4"><a href="#cb5-4" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(<span class="st">&quot;Error al ejecutar el comando:&quot;</span>, e)</span></code></pre>
  ...
  <p>Si solo necesitas la salida (más cómodo que <code>.run()</code>):</p>
...
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(<span class="st">&quot;Usuario actual:&quot;</span>, salida.strip())</span></code></pre>
  ...
  <p>👉 Esto ejecuta el comando y <strong>devuelve la salida como
      string</strong>.</p>
  <hr />
...
<span id="cb7-7"><a href="#cb7-7" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(resultado.stdout)</span></code></pre>
  ...
  <hr />
  <h2 id="ejecutar-múltiples-procesos-encadenados">7. Ejecutar múltiples
    procesos (encadenados)</h2>
  <p>Puedes <strong>conectar la salida de un comando a otro</strong> como
    en una tubería (<code>|</code> en la terminal):</p>
...
<span id="cb10-8"><a href="#cb10-8" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(<span class="st">&quot;Código de salida:&quot;</span>, p.returncode)</span></code></pre>
  ...
  <p>Esto abrirá VLC <strong>sin bloquear</strong> el resto de tu
    script.</p>
  <hr />
  ...
  <p>🚫 <strong>Evita esto (riesgo de inyección):</strong></p>
  ...
  <p>Usar <code>shell=True</code> puede ejecutar código malicioso si la
    entrada del usuario no está validada.</p>
  <hr />
  <h2 id="ejemplo-práctico-medir-tiempo-de-ejecución">11. Ejemplo
    práctico: medir tiempo de ejecución</h2>
...
<span id="cb15-12"><a href="#cb15-12" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(resultado.stdout)</span></code></pre>
  ...
  <p>🧹 Esto ejecuta varios comandos del sistema uno tras otro y muestra
    su salida.</p>
  <hr />
