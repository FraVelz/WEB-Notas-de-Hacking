...
<body>
  ...
  <p><a href="./../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-python">1. ¿Qué es Python?</h2>
  <p><strong>Python</strong> es un lenguaje de programación:</p>
  <ul>
  ...
  <hr />
  <h2 id="sintaxis-básica">2. Sintaxis básica</h2>
  <h3 id="variables-y-tipos-de-datos">Variables y tipos de datos</h3>
...
<span id="cb3-5"><a href="#cb3-5" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(a <span class="op">//</span> b) <span class="co"># División entera</span></span></code></pre>
  ...
  <hr />
  <h2 id="control-de-flujo">3. Control de flujo</h2>
...
<span id="cb5-5"><a href="#cb5-5" aria-hidden="true" tabindex="-1"></a>    edad <span class="op">+=</span> <span class="dv">1</span></span></code></pre>
  ...
  <hr />
  <h2 id="estructuras-de-datos">4. Estructuras de datos</h2>
...
<span id="cb9-2"><a href="#cb9-2" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(persona[<span class="st">&quot;nombre&quot;</span>])</span></code></pre>
  ...
  <hr />
  <h2 id="funciones">5. Funciones</h2>
...
<span id="cb10-4"><a href="#cb10-4" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(saludar(<span class="st">&quot;Francisco&quot;</span>))</span></code></pre>
  ...
  <hr />
  <h2 id="programación-orientada-a-objetos-poo">6. Programación orientada
    a objetos (POO)</h2>
...
<span id="cb11-10"><a href="#cb11-10" aria-hidden="true" tabindex="-1"></a>p1.saludar()</span></code></pre>
  ...
  <hr />
  <h2 id="módulos-y-paquetes">7. Módulos y paquetes</h2>
...
<span id="cb12-2"><a href="#cb12-2" aria-hidden="true" tabindex="-1"></a><span class="bu">print</span>(math.sqrt(<span class="dv">16</span>))  <span class="co"># 4.0</span></span></code></pre>
  ...
  <p>También puedes crear tus propios módulos (<code>mimodulo.py</code>) y
    luego:</p>
...
<span id="cb14-5"><a href="#cb14-5" aria-hidden="true" tabindex="-1"></a>    <span class="bu">print</span>(archivo.read())</span></code></pre>
  ...
  <hr />
  <h2 id="librerías-populares-por-áreas">9. Librerías populares (por
    áreas)</h2>
  <table>
    <colgroup>
      <col style="width: 33%" />
  ...
  <hr />
  <h2 id="conceptos-avanzados">10. Conceptos avanzados</h2>
  <ul>
    <li>
    ...
    <li>
      <p><strong>Generadores (<code>yield</code>)</strong></p>
    </li>
    <li>
      <p><strong>Manejo de errores
          (<code>try/except</code>)</strong></p>
    </li>
    <li>
      <p><strong>Multithreading y multiprocessing</strong></p>
    </li>
    <li>
      <p><strong>Expresiones regulares (<code>re</code>)</strong></p>
    </li>
  </ul>
  <hr />
  <h2 id="herramientas-y-entorno">11. Herramientas y entorno</h2>
  <ul>
    <li>
      <p><strong>Ejecutar:</strong>
        <code>python archivo.py</code>
      </p>
    </li>
    <li>
      <p><strong>Gestor de paquetes:</strong>
        <code>pip install nombre_paquete</code>
      </p>
    </li>
    <li>
      <p><strong>Entornos virtuales:</strong></p>
