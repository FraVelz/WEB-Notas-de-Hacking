...
function Filtraciones() {
  return (
    <>
      <Titulo title="h1" id="filtraciones-de-datos">Filtraciones de datos</Titulo>
      <Texto>Guía para saber si tus datos están filtrados:</Texto>
      <Linea />
      <Titulo title="h2" id="temario">Temario</Titulo>
      <Lista>
        <li>
          <a href="#filtraciones-de-datos">Filtraciones de datos</a>
          <Lista>
            <li>
            ...
            <li>
              <a href="#1-have-i-been-pwned">1. Have I been pwned</a>
            </li>
            <li>
              <a href="#2-firefox-monitor">2. Firefox Monitor</a>
            </li>
            <li>
              <a href="#3-dark-web-google">3. Dark Web Google</a>
            </li>
            <li>
              <a href="#4-inteligencex">4. InteligenceX</a>
            </li>
            <li>
              <a href="#5-dehashed">5. Dehashed</a>
            </li>
          </Lista>
        </li>
      </Lista>
      ...
      <Linea />
      <Titulo title="h2" id="have-i-been-pwned">1. Have I been pwned</Titulo>
      <Texto>
      ...
      <Texto>
        Have I been pwned: (
        <a href="https://haveibeenpwned.com/">Ir a HaveIbeenPwned</a>) Sirve
        para buscar si tu información ha sido filtrada por medio del correo
        electrónico.
      </Texto>
      <Linea />
      <Titulo title="h2" id="firefox-monitor">2. Firefox Monitor</Titulo>
      <Texto>
        Esta herramienta Firefox monitor también es igual que la anterior solo
        que es un servicio oficial del propio Firefox{" "}
        <a href="https://www.google.com/url?sa=t&amp;source=web&amp;rct=j&amp;opi=89978449&amp;url=https://translate.google.com/translate%3Fu%3Dhttps://monitor.mozilla.org/%26hl%3Des%26sl%3Den%26tl%3Des%26client%3Dsrp&amp;ved=2ahUKEwj9_qy8-6OQAxUqSjABHZHXDf8QFnoECBUQAQ&amp;usg=AOvVaw2H3Ecmq4usWvGz2VmX9YLp">
          Ir a Firefox Monitor
        </a>
      </Texto>
      <Linea />
      <Titulo title="h2" id="dark-web-google">3. Dark Web Google</Titulo>
      <Texto>
      ...
      <Texto>
        <a href="https://myactivity.google.com/dark-web-report/dashboard?hl=es&amp;utm_source=google-account&amp;utm_medium=web&amp;utm_campaign=my_account_dark_web_report_member_card&amp;pli=1">
          Ir a Google Reporte Dark Web
        </a>
      </Texto>
      <Linea />
      <Titulo title="h2" id="inteligencex">4. InteligenceX</Titulo>
      <Texto>
      ...
      <Texto>
        <a href="https://intelx.io/">Ir a InteligenceX</a>
      </Texto>
      <Linea />
      <Titulo title="h2" id="dehashed">5. Dehashed</Titulo>
      <Texto>
