...
| `tracert <host>`                        | Ruta aproximada (_traceroute_) hasta el destino.                              |
...
- En entornos de dominio, políticas de grupo pueden restringir qué comandos están disponibles o qué registros DNS se
  usan.
