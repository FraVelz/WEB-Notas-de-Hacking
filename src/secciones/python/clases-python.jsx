...
print(a.ruedas, b.ruedas)  # ambos tienen 4`} language="python" />
      ...
      <CodeBlock code={`def mostrar(self):
...
print(self.__nombre)`} language="python" />
      ...
      <CodeBlock code={`class Rectangulo:
