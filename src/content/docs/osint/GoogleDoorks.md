...
Los **dorks** son **operadores de búsqueda avanzada** (en Google u otros buscadores compatibles) para acotar resultados:
por sitio, texto en URL, título, tipo de archivo, etc. Son útiles en investigación pasiva y en auditorías
**autorizadas**.
