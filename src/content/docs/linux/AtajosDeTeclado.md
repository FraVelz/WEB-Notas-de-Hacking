...
Atajos habituales en la **terminal** con interpretadores tipo **Bash** o **Zsh**. La tecla **Ctrl** se indica como
`Ctrl`; en algunos teclados aparece como `Control`.
...
| `Ctrl+D`            | En línea vacía: **cerrar** la sesión del shell (_EOF_). Con texto: a veces borra el carácter bajo el cursor. |
| `Ctrl+R`            | **Búsqueda inversa** en el historial de comandos (volver a buscar con `Ctrl+R`).                             |
| `Ctrl+T`            | Intercambiar el carácter bajo el cursor con el anterior (_transpose_).                                       |
