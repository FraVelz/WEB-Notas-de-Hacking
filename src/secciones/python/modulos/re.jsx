...
function nameabcd({ }) {
  return (
    <>
      ...
      <CodeBlock code={`import re`} language="python" />
      <Linea />
...
print(m.group())  # Hola`} language="python" />
      ...
      <Texto>Busca <strong>en cualquier parte</strong> del texto (la primera
        coincidencia).</Texto>
      <CodeBlock code={`re.search(r"mundo", "Hola mundo").group()  # mundo`} language="python" />
      <Linea />
      ...
      <CodeBlock code={`re.findall(r"\d+", "Edad 17 años, código 2025")  # ['17', '2025']`} language="python" />
      <Linea />
      ...
      <CodeBlock code={`for m in re.finditer(r"\d+", "x=5 y=10 z=20"):
print(m.group(), m.start(), m.end())`} language="python" />
      ...
      <CodeBlock code={`re.sub(r"\d+", "X", "Tengo 2 perros y 3 gatos")  # 'Tengo X perros y X gatos'`} language="python" />
      <Linea />
      ...
      <CodeBlock code={`re.split(r"\s+", "uno   dos tres")  # ['uno', 'dos', 'tres']`} language="python" />
      <Linea />
      ...
      <CodeBlock code={`patron = re.compile(r"\d+")
print(patron.findall("a1b22c333"))  # ['1', '22', '333']`} language="python" />
      ...
      <CodeBlock code={`m = re.search(r"(\d+)", "Edad: 25 años")
print(m.group())    # '25'
print(m.start())    # 6
print(m.end())      # 8
print(m.span())     # (6, 8)`} language="python" />
      <Texto>Sí hay <strong>grupos</strong> (entre paréntesis):</Texto>
      <CodeBlock code={`m = re.search(r"(\d+)\s*(años)", "Edad: 25 años")
...
print(m.group(2))   # 'años'`} language="python" />
  ...
  <tbody>
    ...
    <TablaFila>
      ...
      <Texto>Ejemplo:</Texto>
      <CodeBlock code={`patron = re.compile(r"""
...
print(bool(re.match(patron, "usuario@mail.com")))  # True`} language="python" />
      ...
      <CodeBlock code={`re.findall(r"\d+", "ID123, edad 45, año 2025")  # ['123', '45', '2025']`} language="python" />
      <Linea />
      <Titulo title="h3" id="reemplazar-palabras">3. Reemplazar palabras</Titulo>
      <CodeBlock code={`texto = "Hola mundo cruel"
...
print(nuevo)  # Hola mundo hermoso`} language="python" />
      ...
      <Titulo title="h3" id="separar-texto-por-comas-o-espacios">4. Separar texto por comas o
        espacios</Titulo>
      <CodeBlock code={`re.split(r"[, ]+", "rojo, verde azul,amarillo")  # ['rojo', 'verde', 'azul', 'amarillo']`} language="python" />
      <Linea />
      ...
      <CodeBlock code={`re.findall(r"", "")  # ['', '']`} language="python" />
      <Linea />
