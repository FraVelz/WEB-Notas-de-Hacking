...
<body>
  <h1 id="comandos-y-cmdlets-de-gestión-de-procesos">Comandos y cmdlets de
    gestión de procesos</h1>
  ...
  <hr />
  <h2 id="comandos-de-gestión-de-procesos-en-cmd">1. Comandos de gestión
    de procesos en CMD</h2>
  <blockquote>
    <p>Todos estos se ejecutan en <strong>Símbolo del sistema
        (cmd)</strong>, preferiblemente con permisos de administrador.</p>
  </blockquote>
  <table>
    <colgroup>
      <col style="width: 29%" />
  ...
  <hr />
  <h2 id="cmdlets-de-gestión-de-procesos-en-powershell">2. Cmdlets de
    gestión de procesos en PowerShell</h2>
  <blockquote>
    <p>PowerShell ofrece control total sobre los procesos, con más detalle y
      opciones que CMD.</p>
  </blockquote>
  <table>
    <colgroup>
  ...
  <hr />
  <h2 id="comparativa-rápida-cmd-vs-powershell">3. Comparativa rápida CMD
    vs PowerShell</h2>
  <table>
    <colgroup>
      <col style="width: 23%" />
  ...
  <hr />
  <h2 id="comandos-gráficos-y-herramientas-integradas">4. Comandos
    gráficos y herramientas integradas</h2>
  <table>
    <colgroup>
      <col style="width: 15%" />
      <col style="width: 84%" />
  ...
  <hr />
  <h2 id="ejemplos-útiles-de-powershell">Ejemplos útiles de
    PowerShell</h2>
