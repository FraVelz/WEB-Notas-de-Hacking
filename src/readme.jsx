...
function Readme() {
  return (
    ...
    ">
        <li>
            <Enlace href="#0-conceptos-básicos">Conceptos Básicos</Enlace>
        </li>

        <li>
            <Enlace href="#1-virtualización">Virtualización</Enlace>
        </li>
        ...
        <li>
            <Enlace href="#4-practica-general">Practica general</Enlace>
        </li>
    </Lista>
    </li>

    <li>
        <Enlace href="#3-windows">Windows</Enlace>
    </li>
    <li>
        <Enlace href="#4-redes">Redes</Enlace>
    </li>
    <li>
        <Enlace href="#5-python">Python</Enlace>
    </li>
    <li>
        <Enlace href="#6-pentesting">Pentesting</Enlace>
    </li>
    <li>
        <Enlace href="#7-osint">OSINT</Enlace>
    </li>
    <li>
        <Enlace href="#8-privacidad-y-anonimato">Privacidad y Anonimato</Enlace>
    </li>

    <li>
        <Enlace href="#información">Información</Enlace>
    </li>
    ...
    <Titulo title="h2" id="0-conceptos-básicos">Conceptos Básicos</Titulo>
    ...
    <Titulo title="h2" id="virtualización">Virtualización</Titulo>
    ...
    <Titulo title="h2" id="linux-y-bash-script">Linux y Bash Script</Titulo>
    ...
    <h3 id="linux-comandos-por-secciones">Linux (comandos por secciones)</h3>
    ...
    ">
        <li>
            <a href="https://www.bonaval.com/kb/cheats-chuletas/comandos-basicos-linux">Ir a /www.bonaval.com/ Comandos
                Basicos de Linux</a>
        </li>
    </Lista>
    <h3 id="linux-comandos-individuales">Linux (comandos individuales)</h3>
    <ul>
        <li>
            <Texto>
    ...
    <ul>
        <li>
            <Texto>
                <Enlace href="https:/www.youtube.com/watch?v=RUorAzaDftg">Ir a curso de bash script desde cero - El
                    pinguino de mario
                    (30m)</Enlace>
            </Texto>
        </li>
    ...
    <h3 id="practica-general">Practica general</h3>
    <ul>
        <li>
    ...
    <Titulo title="h2" id="windows">Windows</Titulo>
    ...
    <Titulo title="h2" id="redes">Redes</Titulo>
    ...
    <ul>
        ...
        <li>
            <Texto>Subnetting: <Enlace href="./redes/subnetting.md">Ir a subnetting</Enlace>
            </Texto>
        </li>
        <li>
            <Texto>
    ...
    <ul>
        <li>
            <Texto>
                <Enlace href="https:/www.youtube.com/watch?v=OLSKCWjI778">Ir curso de YouTube Contando bits - Redes
                    Informáticas</Enlace>
            </Texto>
        </li>
        <li>
            <Texto>
                <Enlace href="https:/www.youtube.com/watch?v=7ejIdyu8hug">Ir curso de YouTube Hixec - Redes para
                    ciberseguridad</Enlace>
            </Texto>
        </li>
    </ul>
    ...
    <Titulo title="h2" id="python">Python</Titulo>
    <Texto><strong>Duración aproximada (2h diarias):</strong> 1 mes.</Texto>
    <Texto>Notas:</Texto>
    <ul>
        <li>
        ...
        <li>
            <Texto>
                <Enlace href="./python/classmethod.md">Ir a decorador
        ...
        <li>
            <Texto>
                <Enlace href="./python/property.md">Ir a decorador
    ...
    <Titulo title="h2" id="pentesting">Pentesting</Titulo>
    <Texto>Temario:</Texto>
    <ol type="1">
        <li>
            <Texto>
    ...
    <Titulo title="h2" id="osint">OSINT</Titulo>
    ...
    <Titulo title="h2" id="privacidad-y-anonimato">Privacidad y Anonimato</Titulo>
    <ol type="1">
        <li>
            <Texto>
