function Conceptos_Generales() {
  return (
    <>
      <h1 id="conceptos-generales-privacidad-anonimato-y-mucho-mas">
      ...
      <ul>
        <li>
          <a href="#conceptos-generales-privacidad-anonimato-y-mucho-mas">
            Conceptos Generales (privacidad, Anonimato y mucho mas)
          </a>
          <ul>
            <li>
            ...
            <li>
              <a href="#1-internet-niveles-o-capas">
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="#cómo-se-logra">Cómo se logra</a>
                </li>
                <li>
                  <a href="#buenas-prácticas-de-anonimato">
            ...
            <li>
              <a href="#3-deep-web-vs-dark-web">3. Deep Web vs Dark Web</a>
            </li>
            <li>
              <a href="#4-legalidad-y-ética">4. Legalidad y ética</a>
            </li>
            <li>
              <a href="#5-tecnologías-principales">
                5. Tecnologías principales
              </a>
            </li>
            <li>
              <a href="#6-riesgos-de-la-dark-web">6. Riesgos de la Dark Web</a>
            </li>
            <li>
              <a href="#7-usos-legítimos-del-anonimato-y-la-dark-web">
      ...
      <hr />
      <h2 id="internet-niveles-o-capas">1. Internet: niveles o capas</h2>
      <p>
      ...
      <h3 id="buenas-prácticas-de-anonimato">Buenas prácticas de anonimato</h3>
      <ul>
      ...
      <hr />
      <h2 id="deep-web-vs-dark-web">3. Deep Web vs Dark Web</h2>
      <table>
        <thead>
          <tr>
            <th>Aspecto</th>
      ...
      <hr />
      <h2 id="legalidad-y-ética">4. Legalidad y ética</h2>
      <ul>
        <li>
          <p>
      ...
      <hr />
      <h2 id="tecnologías-principales">5. Tecnologías principales</h2>
      <table>
        <thead>
          <tr>
            <th>Tecnología</th>
      ...
      <hr />
      <h2 id="riesgos-de-la-dark-web">6. Riesgos de la Dark Web</h2>
      <ul>
        <li>
      ...
      <hr />
      <h2 id="usos-legítimos-del-anonimato-y-la-dark-web">
        7. Usos legítimos del anonimato y la Dark Web
      </h2>
      <ul>
