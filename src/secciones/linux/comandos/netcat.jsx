...
<body>
  <h1 id="netcat-en-linux">Netcat en Linux</h1>
  <hr />
  ...
  <p><a href="./../../readme.md#5-python">Regresar a la Guía
      Principal</a></p>
  <hr />
  <h2 id="qué-es-netcat">¿Qué es Netcat?</h2>
  <p><strong>Netcat</strong> (abreviado <code>nc</code>) es una
    herramienta de línea de comandos usada para:</p>
  <ul>
  ...
  <p>Es conocida como el <strong>“cuchillo suizo de las redes”</strong>
    🧰.</p>
  <hr />
  <h2 id="instalación">Instalación</h2>
  <p>En la mayoría de sistemas viene preinstalado:</p>
  ...
  <p><strong>Windows:</strong> Puedes usar <strong>Ncat</strong> (parte de
    Nmap): 👉 <a href="https://nmap.org/ncat/">https://nmap.org/ncat/</a></p>
  <hr />
  ...
  <hr />
  <h2 id="modos-principales-de-uso">Modos principales de uso</h2>
  <h3 id="cliente-tcp">Cliente TCP</h3>
  <p>Conectarse a un servidor:</p>
  ...
  <p>Esto abre una conexión al puerto 8080 del localhost.</p>
  <h3 id="servidor-tcp">Servidor TCP</h3>
  <p>Escuchar conexiones:</p>
  ...
  <p>🔹 <code>-l</code> → modo escucha</p>
  <p>🔹 <code>-p</code> → especifica el puerto</p>
  <p>Luego, desde otro terminal:</p>
  ...
  <p>Ahora puedes <strong>enviar mensajes entre ambos terminales (chat
      simple)</strong>.</p>
  <hr />
  <h2 id="udp-en-lugar-de-tcp">UDP en lugar de TCP</h2>
  <p>Para usar <strong>UDP</strong> en vez de TCP:</p>
...
<span id="cb7-5"><a href="#cb7-5" aria-hidden="true" tabindex="-1"></a><span class="ex">nc</span> <span class="at">-u</span> 127.0.0.1 6000</span></code></pre>
  ...
  <p>🔹 <code>-u</code> → activa modo UDP.</p>
  <hr />
  <h2 id="transferencia-de-archivos">Transferencia de archivos</h2>
  <h3 id="enviar-un-archivo">Enviar un archivo</h3>
  <p>Servidor que recibirá:</p>
  ...
  <p>👉 El archivo <code>archivo.txt</code> se envía al servidor.</p>
  <hr />
  <h2 id="chat-simple-entre-dos-pcs-tcp">Chat simple entre dos PCs
    (TCP)</h2>
  <p>En una máquina:</p>
  ...
  <p>Ahora ambos pueden escribir y leer mensajes.</p>
  <hr />
  <h2 id="escaneo-de-puertos">Escaneo de puertos</h2>
  <p>Netcat puede escanear qué puertos están abiertos en una máquina:</p>
  ...
  <p>🔹 <code>-z</code> → modo “scan” sin enviar datos.</p>
  <p>🔹 <code>-v</code> → modo verbose (muestra resultado).</p>
  <p>🔹 <code>20-80</code> → rango de puertos.</p>
  <hr />
  <h2 id="redirección-de-entradasalida">Redirección de entrada/salida</h2>
  <p>Puedes usar <strong>pipes</strong> para automatizar tareas:</p>
  ...
  <hr />
  <h2 id="reverse-shells-usos-éticos-y-educativos">Reverse Shells (usos
    éticos y educativos)</h2>
  <p>Netcat puede crear conexiones remotas tipo <strong>shell
      inversa</strong>, usadas en <strong>pentesting</strong> (no
    ilegalmente).</p>
  <h3 id="en-el-servidor-escuchando">En el servidor (escuchando)</h3>
  ...
  <h3 id="en-la-víctima-simulada">En la víctima (simulada)</h3>
  ...
  <p>👉 Esto le da al servidor una consola remota de la otra máquina.
    <em>(Solo en entornos controlados o de práctica legal.)</em>
  </p>
  <hr />
  <h2 id="otras-opciones-útiles">Otras opciones útiles</h2>
  <table>
    <thead>
      <tr>
        <th>Opción</th>
  ...
  <hr />
  <h2 id="ejemplo-práctico-completo">Ejemplo práctico completo</h2>
  <h3 id="crear-servidor-de-eco">Crear servidor de eco</h3>
...
<span id="cb17-2"><a href="#cb17-2" aria-hidden="true" tabindex="-1"></a><span class="ex">nc</span> <span class="at">-l</span> <span class="at">-p</span> 1234 <span class="at">-v</span></span></code></pre>
  ...
  <p>Ahora cualquier texto que envíes se reflejará entre ambos.</p>
  <hr />
  ...
  <hr />
  <h2 id="alternativas-modernas">Alternativas modernas</h2>
  <ul>
