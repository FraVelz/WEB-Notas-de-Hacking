...
<head>
  ...
  <title>gestion-red</title>

</head>

<body>
  <h1 id="comandos-y-cmdlets-de-gestión-de-red">Comandos y cmdlets de
    gestión de red</h1>
  <hr />
  ...
  <p><a href="./../readme.md#3-windows">Regresar a la guía
      principal</a></p>
  <hr />
  <h2 id="cmd-comandos-de-red">CMD — Comandos de Red</h2>
  <table>
    <colgroup>
      <col style="width: 38%" />
      <col style="width: 61%" />
  ...
  <hr />
  <h2 id="powershell-cmdlets-de-red">PowerShell — Cmdlets de Red</h2>
  <table>
    <colgroup>
      <col style="width: 42%" />
      <col style="width: 57%" />
